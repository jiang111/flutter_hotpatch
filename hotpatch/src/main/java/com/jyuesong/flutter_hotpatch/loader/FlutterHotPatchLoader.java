 ...
 */
public class FlutterHotPatchLoader extends FlutterLoader {

    private static FlutterHotPatchLoader instance;
    private File aotSharedLibraryFile;


    public static FlutterHotPatchLoader getInstance() {
        if (instance == null) {
            instance = new FlutterHotPatchLoader();
        }
        return instance;
    }
    ...
    private void hookFlutterLoaderInstance() {
        ...
        try {
            ...
            FlutterHotPatchLoader instance = FlutterHotPatchLoader.getInstance();
    ...
    private boolean isHookedFlutterLoader() {
        return FlutterLoader.getInstance() instanceof FlutterHotPatchLoader;
    }

    private static final String TAG = "FlutterHotPatchLoader";
